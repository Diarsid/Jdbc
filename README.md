...
import diarsid.jdbc.transactions2.PerRowOperation;
...
    try {
...
```
[Jdbc.Transactions] 21 22:03:57.823 ERROR [JdbcTransactionReal] -  
[SQL HISTORY] 
[0] 
...
import diarsid.jdbc.transactions2.SqlHistoryFormattingAlgorithm;
