...
public class FormattingAlgorithmStandardImpl extends FormattingAlgorithm {
    ...
    public FormattingAlgorithmStandardImpl(String parametersLineTabSign) {
        ...
        this.replace = replace()
                ...
                .regexToString("(union|UNION)", LINE_SEPARATOR_TAB_TAB_TAB + "UNION")
                .regexToString("(intersect|INTERSECT)", LINE_SEPARATOR_TAB_TAB_TAB + "INTERSECT")
                ...
                .regexToStringFirstFrom(
                        new ReplacePair("(left join|LEFT JOIN)", LINE_SEPARATOR_TAB_TAB + "LEFT JOIN"),
                        new ReplacePair("(right join|RIGHT JOIN)", LINE_SEPARATOR_TAB_TAB + "RIGHT JOIN"),
                        new ReplacePair("(inner join|INNER JOIN)", LINE_SEPARATOR_TAB_TAB + "RIGHT JOIN"),
                        new ReplacePair("(cross join|CROSS JOIN)", LINE_SEPARATOR_TAB_TAB + "RIGHT JOIN"),
                        new ReplacePair("(join|JOIN)", LINE_SEPARATOR_TAB_TAB + "JOIN"))
